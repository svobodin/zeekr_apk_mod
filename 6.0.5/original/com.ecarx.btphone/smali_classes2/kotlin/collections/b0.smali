...
# direct methods
.method public static A(Ljava/util/Collection;Ld5/e;)Z
    .locals 2
    ...
    .line 1
    invoke-static {p1}, Lkotlin/collections/s;->a(Ld5/e;)Ljava/util/Collection;
...
.method public static B(Ljava/util/Collection;Ljava/lang/Iterable;)Z
    ...
    invoke-static {p1, p0}, Lkotlin/collections/s;->c(Ljava/lang/Iterable;Ljava/lang/Iterable;)Ljava/util/Collection;

    move-result-object p1

    invoke-static {p0}, Lkotlin/jvm/internal/h0;->a(Ljava/lang/Object;)Ljava/util/Collection;
...
.method public static C(Ljava/util/Collection;[Ljava/lang/Object;)Z
    ...
    invoke-static {p1}, Lkotlin/collections/s;->b([Ljava/lang/Object;)Ljava/util/Collection;
...
.method public static D(Ljava/util/List;Lw4/l;)Z
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    invoke-static {p0, p1, v0}, Lkotlin/collections/b0;->y(Ljava/util/List;Lw4/l;Z)Z
...
.method public static u(Ljava/util/Collection;Ld5/e;)Z
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
...
.method private static final x(Ljava/lang/Iterable;Lw4/l;Z)Z
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
...
.method private static final y(Ljava/util/List;Lw4/l;Z)Z
    .locals 6
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    invoke-static {p0}, Lkotlin/jvm/internal/h0;->b(Ljava/lang/Object;)Ljava/lang/Iterable;

    move-result-object p0

    invoke-static {p0, p1, p2}, Lkotlin/collections/b0;->x(Ljava/lang/Iterable;Lw4/l;Z)Z
    ...
    invoke-virtual {v0}, Lb5/d;->h()Lkotlin/collections/j0;
...
.method public static z(Ljava/lang/Iterable;Lw4/l;)Z
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    invoke-static {p0, p1, v0}, Lkotlin/collections/b0;->x(Ljava/lang/Iterable;Lw4/l;Z)Z
