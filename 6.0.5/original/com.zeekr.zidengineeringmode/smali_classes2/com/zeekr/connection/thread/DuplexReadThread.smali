.class public Lcom/zeekr/connection/thread/DuplexReadThread;
...
# instance fields
.field private final mReader:Lcom/zeekr/connection/inter/IReader;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
# direct methods
.method public constructor <init>(Lcom/zeekr/connection/inter/IReader;Lcom/zeekr/connection/inter/IStateSender;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 28
    iput-object p2, p0, Lcom/zeekr/connection/thread/DuplexReadThread;->mStateSender:Lcom/zeekr/connection/inter/IStateSender;

    .line 29
    iput-object p1, p0, Lcom/zeekr/connection/thread/DuplexReadThread;->mReader:Lcom/zeekr/connection/inter/IReader;
...
.method protected beforeLoop()V
    ...
    .line 34
    iget-object v0, p0, Lcom/zeekr/connection/thread/DuplexReadThread;->mStateSender:Lcom/zeekr/connection/inter/IStateSender;
...
.method protected loopFinish(Ljava/lang/Exception;)V
    ...
    const-string v1, "duplex read error,thread is dead with exception:%s"
...
.method protected runInLoopThread()V
    ...
    .line 39
    iget-object v0, p0, Lcom/zeekr/connection/thread/DuplexReadThread;->mReader:Lcom/zeekr/connection/inter/IReader;

    invoke-interface {v0}, Lcom/zeekr/connection/inter/IReader;->read()V
...
.method public declared-synchronized shutdown(Ljava/lang/Exception;)V
    ...
    invoke-interface {v0}, Lcom/zeekr/connection/inter/IReader;->close()V
