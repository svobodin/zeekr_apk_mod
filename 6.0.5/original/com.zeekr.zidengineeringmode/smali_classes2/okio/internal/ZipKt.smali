...
.method public static final openZip(Lokio/Path;Lokio/FileSystem;Lkotlin/jvm/functions/Function1;)Lokio/ZipFileSystem;
    ...
    .line 69
    invoke-static {v5, v7, v8, v6, v4}, Lokio/FileHandle;->source$default(Lokio/FileHandle;JILjava/lang/Object;)Lokio/Source;
    ...
    .line 94
    :goto_0
    invoke-virtual {v5, v9, v10}, Lokio/FileHandle;->source(J)Lokio/Source;
    ...
    .line 98
    invoke-static {v15}, Lokio/internal/ZipKt;->readEocdRecord(Lokio/BufferedSource;)Lokio/internal/EocdRecord;

    move-result-object v6

    .line 99
    invoke-virtual {v6}, Lokio/internal/EocdRecord;->getCommentByteCount()I

    move-result v12

    int-to-long v12, v12

    invoke-interface {v15, v12, v13}, Lokio/BufferedSource;->readUtf8(J)Ljava/lang/String;
    ...
    .line 123
    invoke-virtual {v5, v14, v15}, Lokio/FileHandle;->source(J)Lokio/Source;
    ...
    .line 131
    invoke-static {v8, v6}, Lokio/internal/ZipKt;->readZip64EocdRecord(Lokio/BufferedSource;Lokio/internal/EocdRecord;)Lokio/internal/EocdRecord;
    ...
    .line 139
    invoke-virtual {v6}, Lokio/internal/EocdRecord;->getCentralDirectoryOffset()J

    move-result-wide v8

    invoke-virtual {v5, v8, v9}, Lokio/FileHandle;->source(J)Lokio/Source;
    ...
    .line 140
    invoke-virtual {v6}, Lokio/internal/EocdRecord;->getEntryCount()J
    ...
    invoke-direct {v5, v0, v1, v2, v12}, Lokio/ZipFileSystem;-><init>(Lokio/Path;Lokio/FileSystem;Ljava/util/Map;Ljava/lang/String;)V
    :try_end_10
