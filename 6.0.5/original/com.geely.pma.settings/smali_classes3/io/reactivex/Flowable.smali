...
.method public static d(Lorg/reactivestreams/Publisher;)Lio/reactivex/Flowable;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
...
.method public static e(Ljava/lang/Object;)Lio/reactivex/Flowable;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
...
.method public static u(Ljava/lang/Iterable;Lio/reactivex/functions/Function;ZI)Lio/reactivex/Flowable;
    .locals 7
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
...
# virtual methods
.method public final c(Ljava/lang/Object;)Lio/reactivex/Flowable;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(TT;)",
    ...
    .line 2
    invoke-static {p1}, Lio/reactivex/Flowable;->e(Ljava/lang/Object;)Lio/reactivex/Flowable;

    move-result-object p1

    invoke-virtual {p0, p1}, Lio/reactivex/Flowable;->t(Lorg/reactivestreams/Publisher;)Lio/reactivex/Flowable;
...
.method public final f(Lio/reactivex/functions/Function;)Lio/reactivex/Flowable;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<R:",
...
.method public final g()Lio/reactivex/Flowable;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
...
.method public final h(Lio/reactivex/Scheduler;)Lio/reactivex/Flowable;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {p0, p1, v1, v0}, Lio/reactivex/Flowable;->i(Lio/reactivex/Scheduler;ZI)Lio/reactivex/Flowable;
...
.method public final i(Lio/reactivex/Scheduler;ZI)Lio/reactivex/Flowable;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public final j()Lio/reactivex/Flowable;
    ...
    invoke-virtual {p0, v0, v1, v2}, Lio/reactivex/Flowable;->k(IZZ)Lio/reactivex/Flowable;
...
.method public final k(IZZ)Lio/reactivex/Flowable;
    .locals 7
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(IZZ)",
...
.method public final l()Lio/reactivex/Flowable;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
...
.method public final n()Lio/reactivex/flowables/ConnectableFlowable;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
    ...
    invoke-static {p0}, Lio/reactivex/internal/operators/flowable/FlowableReplay;->A(Lio/reactivex/Flowable;)Lio/reactivex/flowables/ConnectableFlowable;
...
.method public final o(I)Lio/reactivex/flowables/ConnectableFlowable;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(I)",
    ...
    .line 2
    invoke-static {p0, p1}, Lio/reactivex/internal/operators/flowable/FlowableReplay;->w(Lio/reactivex/Flowable;I)Lio/reactivex/flowables/ConnectableFlowable;
...
.method public final p(IJLjava/util/concurrent/TimeUnit;Lio/reactivex/Scheduler;)Lio/reactivex/flowables/ConnectableFlowable;
    .locals 6
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(IJ",
    ...
    .line 2
    invoke-static {p4, v1}, Lio/reactivex/internal/functions/ObjectHelper;->d(Ljava/lang/Object;Ljava/lang/String;)Ljava/lang/Object;

    const-string v1, "scheduler is null"

    .line 3
    invoke-static {p5, v1}, Lio/reactivex/internal/functions/ObjectHelper;->d(Ljava/lang/Object;Ljava/lang/String;)Ljava/lang/Object;
    ...
    .line 5
    invoke-static/range {v0 .. v5}, Lio/reactivex/internal/operators/flowable/FlowableReplay;->y(Lio/reactivex/Flowable;JLjava/util/concurrent/TimeUnit;Lio/reactivex/Scheduler;I)Lio/reactivex/flowables/ConnectableFlowable;
...
.method public final q(JLjava/util/concurrent/TimeUnit;Lio/reactivex/Scheduler;)Lio/reactivex/flowables/ConnectableFlowable;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(J",
    ...
    .line 3
    invoke-static {p0, p1, p2, p3, p4}, Lio/reactivex/internal/operators/flowable/FlowableReplay;->x(Lio/reactivex/Flowable;JLjava/util/concurrent/TimeUnit;Lio/reactivex/Scheduler;)Lio/reactivex/flowables/ConnectableFlowable;
...
.method public final r(Lio/reactivex/FlowableSubscriber;)V
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 4
    invoke-virtual {p0, p1}, Lio/reactivex/Flowable;->s(Lorg/reactivestreams/Subscriber;)V
    :try_end_0
...
.method public final subscribe(Lorg/reactivestreams/Subscriber;)V
    ...
    invoke-virtual {p0, p1}, Lio/reactivex/Flowable;->r(Lio/reactivex/FlowableSubscriber;)V
    ...
    invoke-virtual {p0, v0}, Lio/reactivex/Flowable;->r(Lio/reactivex/FlowableSubscriber;)V

    :goto_0
    return-void
.end method

.method public final t(Lorg/reactivestreams/Publisher;)Lio/reactivex/Flowable;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
