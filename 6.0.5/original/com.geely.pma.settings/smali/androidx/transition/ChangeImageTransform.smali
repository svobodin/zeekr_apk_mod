...
.method private A0(Landroid/widget/ImageView;Landroid/graphics/Matrix;Landroid/graphics/Matrix;)Landroid/animation/ObjectAnimator;
    .locals 4
...
.method private B0(Landroid/widget/ImageView;)Landroid/animation/ObjectAnimator;
    .locals 5
...
.method private u0(Landroidx/transition/TransitionValues;)V
    ...
    .line 12
    invoke-static {v1}, Landroidx/transition/ChangeImageTransform;->z0(Landroid/widget/ImageView;)Landroid/graphics/Matrix;
...
.method private static y0(Landroid/widget/ImageView;)Landroid/graphics/Matrix;
    .locals 5
...
.method private static z0(Landroid/widget/ImageView;)Landroid/graphics/Matrix;
    ...
    .line 4
    :cond_0
    invoke-static {p0}, Landroidx/transition/ChangeImageTransform;->y0(Landroid/widget/ImageView;)Landroid/graphics/Matrix;
    ...
    .line 5
    :cond_1
    invoke-static {p0}, Landroidx/transition/ChangeImageTransform;->C0(Landroid/widget/ImageView;)Landroid/graphics/Matrix;
...
.method public g(Landroidx/transition/TransitionValues;)V
    ...
    invoke-direct {p0, p1}, Landroidx/transition/ChangeImageTransform;->u0(Landroidx/transition/TransitionValues;)V
...
.method public n(Landroid/view/ViewGroup;Landroidx/transition/TransitionValues;Landroidx/transition/TransitionValues;)Landroid/animation/Animator;
    ...
    .line 14
    invoke-direct {p0, p1, p2, v2}, Landroidx/transition/ChangeImageTransform;->A0(Landroid/widget/ImageView;Landroid/graphics/Matrix;Landroid/graphics/Matrix;)Landroid/animation/ObjectAnimator;
    ...
    :cond_9
    :goto_1
    invoke-direct {p0, p1}, Landroidx/transition/ChangeImageTransform;->B0(Landroid/widget/ImageView;)Landroid/animation/ObjectAnimator;
