...
.method constructor <init>(Ljava/lang/String;Lokhttp3/HttpUrl;Ljava/lang/String;Lokhttp3/Headers;Lokhttp3/MediaType;ZZZ)V
    ...
    .line 12
    sget-object p2, Lokhttp3/MultipartBody;->j:Lokhttp3/MediaType;
...
.method private static i(Ljava/lang/String;Z)Ljava/lang/String;
    ...
    .line 6
    invoke-virtual {v3, p0, v1, v2}, Lokio/Buffer;->s1(Ljava/lang/String;II)Lokio/Buffer;

    .line 7
    invoke-static {v3, p0, v2, v0, p1}, Lretrofit2/RequestBuilder;->j(Lokio/Buffer;Ljava/lang/String;IIZ)V

    .line 8
    invoke-virtual {v3}, Lokio/Buffer;->G0()Ljava/lang/String;
...
.method private static j(Lokio/Buffer;Ljava/lang/String;IIZ)V
    ...
    .line 3
    :cond_1
    invoke-virtual {p0, v1}, Lokio/Buffer;->t1(I)Lokio/Buffer;
    ...
    .line 5
    :cond_3
    invoke-virtual {v0, v1}, Lokio/Buffer;->t1(I)Lokio/Buffer;
    ...
    .line 8
    invoke-virtual {p0, v3}, Lokio/Buffer;->i1(I)Lokio/Buffer;
...
.method h(Ljava/lang/Class;Ljava/lang/Object;)V
    ...
    invoke-virtual {v0, p1, p2}, Lokhttp3/Request$Builder;->n(Ljava/lang/Class;Ljava/lang/Object;)Lokhttp3/Request$Builder;
...
.method k()Lokhttp3/Request$Builder;
    ...
    invoke-virtual {v0, v2}, Lokhttp3/Request$Builder;->j(Lokhttp3/Headers;)Lokhttp3/Request$Builder;

    move-result-object v0

    iget-object v2, p0, Lretrofit2/RequestBuilder;->a:Ljava/lang/String;

    invoke-virtual {v0, v2, v1}, Lokhttp3/Request$Builder;->k(Ljava/lang/String;Lokhttp3/RequestBody;)Lokhttp3/Request$Builder;
