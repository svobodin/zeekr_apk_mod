...
.field public static final f:Lokhttp3/internal/http2/Http2Reader$Companion;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lokhttp3/internal/http2/Http2Reader;->f:Lokhttp3/internal/http2/Http2Reader$Companion;
...
.method private final A(Lokhttp3/internal/http2/Http2Reader$Handler;III)V
    ...
    invoke-static {v3, v4}, Lokhttp3/internal/Util;->c(SI)I
    ...
    .line 12
    :cond_b
    invoke-interface {p1, v0, p3}, Lokhttp3/internal/http2/Http2Reader$Handler;->b(ZLokhttp3/internal/http2/Settings;)V
...
.method private final B(Lokhttp3/internal/http2/Http2Reader$Handler;III)V
    ...
    invoke-static {p2, v0, v1}, Lokhttp3/internal/Util;->d(IJ)J
    ...
    .line 2
    invoke-interface {p1, p4, p2, p3}, Lokhttp3/internal/http2/Http2Reader$Handler;->d(IJ)V
...
.method private final g(Lokhttp3/internal/http2/Http2Reader$Handler;III)V
    ...
    invoke-static {v1, v2}, Lokhttp3/internal/Util;->b(BI)I

    move-result v1

    .line 2
    :cond_2
    sget-object v2, Lokhttp3/internal/http2/Http2Reader;->f:Lokhttp3/internal/http2/Http2Reader$Companion;
    ...
    invoke-interface {p1, v0, p4, p3, p2}, Lokhttp3/internal/http2/Http2Reader$Handler;->e(ZILokio/BufferedSource;I)V
...
.method private final h(Lokhttp3/internal/http2/Http2Reader$Handler;III)V
    ...
    invoke-interface {v0, v1, v2}, Lokio/BufferedSource;->d(J)Lokio/ByteString;

    move-result-object v0

    .line 6
    :cond_0
    invoke-interface {p1, p4, p3, v0}, Lokhttp3/internal/http2/Http2Reader$Handler;->j(ILokhttp3/internal/http2/ErrorCode;Lokio/ByteString;)V
...
.method private final i(IIII)Ljava/util/List;
    ...
    invoke-virtual {v0, p1}, Lokhttp3/internal/http2/Http2Reader$ContinuationSource;->g(I)V
    ...
    invoke-virtual {p1, v0}, Lokhttp3/internal/http2/Http2Reader$ContinuationSource;->h(I)V

    .line 3
    iget-object p1, p0, Lokhttp3/internal/http2/Http2Reader;->a:Lokhttp3/internal/http2/Http2Reader$ContinuationSource;

    invoke-virtual {p1, p2}, Lokhttp3/internal/http2/Http2Reader$ContinuationSource;->i(I)V
    ...
    invoke-virtual {p1, p4}, Lokhttp3/internal/http2/Http2Reader$ContinuationSource;->l(I)V
...
.method private final l(Lokhttp3/internal/http2/Http2Reader$Handler;III)V
    ...
    .line 2
    invoke-direct {p0, p1, p4}, Lokhttp3/internal/http2/Http2Reader;->w(Lokhttp3/internal/http2/Http2Reader$Handler;I)V
    ...
    .line 4
    invoke-direct {p0, p2, v1, p3, p4}, Lokhttp3/internal/http2/Http2Reader;->i(IIII)Ljava/util/List;
...
.method private final w(Lokhttp3/internal/http2/Http2Reader$Handler;I)V
    .locals 5
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    invoke-static {v3, v4}, Lokhttp3/internal/Util;->b(BI)I
...
.method private final x(Lokhttp3/internal/http2/Http2Reader$Handler;III)V
    .locals 0
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
...
.method private final y(Lokhttp3/internal/http2/Http2Reader$Handler;III)V
    .locals 3
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    .line 4
    invoke-direct {p0, p2, v0, p3, p4}, Lokhttp3/internal/http2/Http2Reader;->i(IIII)Ljava/util/List;
...
.method private final z(Lokhttp3/internal/http2/Http2Reader$Handler;III)V
    ...
    .line 3
    invoke-interface {p1, p4, p3}, Lokhttp3/internal/http2/Http2Reader$Handler;->h(ILokhttp3/internal/http2/ErrorCode;)V
...
.method public final b(ZLokhttp3/internal/http2/Http2Reader$Handler;)Z
    ...
    invoke-static {v0}, Lokhttp3/internal/Util;->H(Lokio/BufferedSource;)I
    ...
    sget-object v1, Lokhttp3/internal/http2/Http2;->e:Lokhttp3/internal/http2/Http2;
    ...
    sget-object v0, Lokhttp3/internal/http2/Http2;->e:Lokhttp3/internal/http2/Http2;
    ...
    .line 12
    :pswitch_3
    invoke-direct {p0, p2, v0, v8, v9}, Lokhttp3/internal/http2/Http2Reader;->y(Lokhttp3/internal/http2/Http2Reader$Handler;III)V
    ...
    .line 15
    :pswitch_6
    invoke-direct {p0, p2, v0, v8, v9}, Lokhttp3/internal/http2/Http2Reader;->x(Lokhttp3/internal/http2/Http2Reader$Handler;III)V
...
.method public final c(Lokhttp3/internal/http2/Http2Reader$Handler;)V
    ...
    invoke-interface {p1, v2, v3}, Lokio/BufferedSource;->d(J)Lokio/ByteString;
    ...
    invoke-static {v3, v4}, Lokhttp3/internal/Util;->q(Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/String;
