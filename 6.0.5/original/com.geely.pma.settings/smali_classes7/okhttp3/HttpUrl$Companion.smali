...
.method private final e(Ljava/lang/String;II)Z
    ...
    invoke-static {p2}, Lokhttp3/internal/Util;->F(C)I
    ...
    invoke-static {p1}, Lokhttp3/internal/Util;->F(C)I
...
.method public static synthetic g(Lokhttp3/HttpUrl$Companion;Ljava/lang/String;IIZILjava/lang/Object;)Ljava/lang/String;
    .locals 1
    ...
    .line 2
    :cond_2
    invoke-virtual {p0, p1, p2, p3, p4}, Lokhttp3/HttpUrl$Companion;->f(Ljava/lang/String;IIZ)Ljava/lang/String;
...
.method private final k(Lokio/Buffer;Ljava/lang/String;IILjava/lang/String;ZZZZLjava/nio/charset/Charset;)V
    .locals 14
    ...
    .line 2
    :goto_3
    invoke-virtual {p1, v8}, Lokio/Buffer;->r1(Ljava/lang/String;)Lokio/Buffer;
    ...
    .line 5
    :cond_6
    invoke-virtual {p1, v7}, Lokio/Buffer;->t1(I)Lokio/Buffer;
    ...
    invoke-virtual {v6, v1, v5, v10, v3}, Lokio/Buffer;->p1(Ljava/lang/String;IILjava/nio/charset/Charset;)Lokio/Buffer;
    ...
    :cond_b
    :goto_5
    invoke-virtual {v6, v7}, Lokio/Buffer;->t1(I)Lokio/Buffer;

    .line 10
    :goto_6
    invoke-virtual {v6}, Lokio/Buffer;->L()Z
    ...
    .line 12
    invoke-virtual {p1, v9}, Lokio/Buffer;->i1(I)Lokio/Buffer;
    ...
    invoke-virtual {p1, v11}, Lokio/Buffer;->i1(I)Lokio/Buffer;
    ...
    invoke-virtual {p1, v10}, Lokio/Buffer;->i1(I)Lokio/Buffer;
...
.method private final l(Lokio/Buffer;Ljava/lang/String;IIZ)V
    .locals 5
    ...
    invoke-static {v2}, Lokhttp3/internal/Util;->F(C)I
    ...
    invoke-static {v3}, Lokhttp3/internal/Util;->F(C)I
    ...
    .line 4
    invoke-virtual {p1, p3}, Lokio/Buffer;->i1(I)Lokio/Buffer;
    ...
    .line 7
    :cond_1
    invoke-virtual {p1, v0}, Lokio/Buffer;->t1(I)Lokio/Buffer;
...
.method public final a(Ljava/lang/String;IILjava/lang/String;ZZZZLjava/nio/charset/Charset;)Ljava/lang/String;
    ...
    .line 6
    invoke-virtual {v12, p1, p2, v3}, Lokio/Buffer;->s1(Ljava/lang/String;II)Lokio/Buffer;
    ...
    .line 7
    invoke-direct/range {v0 .. v10}, Lokhttp3/HttpUrl$Companion;->k(Lokio/Buffer;Ljava/lang/String;IILjava/lang/String;ZZZZLjava/nio/charset/Charset;)V

    .line 8
    invoke-virtual {v12}, Lokio/Buffer;->G0()Ljava/lang/String;
...
.method public final f(Ljava/lang/String;IIZ)Ljava/lang/String;
    ...
    .line 3
    invoke-virtual {v0, p1, p2, v4}, Lokio/Buffer;->s1(Ljava/lang/String;II)Lokio/Buffer;
    ...
    .line 4
    invoke-direct/range {v1 .. v6}, Lokhttp3/HttpUrl$Companion;->l(Lokio/Buffer;Ljava/lang/String;IIZ)V
