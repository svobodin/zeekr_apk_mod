...
.method bridge synthetic i(Lr/a;F)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1, p2}, Lh/d;->r(Lr/a;F)Ljava/lang/Float;
...
.method public p()F
    ...
    invoke-virtual {p0, v0, v1}, Lh/d;->q(Lr/a;F)F
...
.method q(Lr/a;F)F
    ...
    .line 7
    :cond_0
    invoke-virtual {p1}, Lr/a;->f()F

    move-result v0

    invoke-virtual {p1}, Lr/a;->c()F

    move-result p1

    invoke-static {v0, p1, p2}, Lq/g;->i(FFF)F
...
.method r(Lr/a;F)Ljava/lang/Float;
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {p0, p1, p2}, Lh/d;->q(Lr/a;F)F
