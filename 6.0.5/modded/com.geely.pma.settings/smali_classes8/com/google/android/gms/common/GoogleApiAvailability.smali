...
.method private final A(Landroid/content/Context;ILjava/lang/String;Landroid/app/PendingIntent;)V
    ...
    .line 6
    invoke-static {p1, p2}, Lcom/google/android/gms/common/internal/zac;->h(Landroid/content/Context;I)Ljava/lang/String;
    ...
    .line 11
    invoke-virtual {v6, v3}, Landroidx/core/app/NotificationCompat$Builder;->f(Z)Landroidx/core/app/NotificationCompat$Builder;

    move-result-object v6

    .line 12
    invoke-virtual {v6, v0}, Landroidx/core/app/NotificationCompat$Builder;->j(Ljava/lang/CharSequence;)Landroidx/core/app/NotificationCompat$Builder;
    ...
    invoke-virtual {v0, v6}, Landroidx/core/app/NotificationCompat$Builder;->r(Landroidx/core/app/NotificationCompat$Style;)Landroidx/core/app/NotificationCompat$Builder;
    ...
    invoke-virtual {v0, v1}, Landroidx/core/app/NotificationCompat$Builder;->q(I)Landroidx/core/app/NotificationCompat$Builder;

    move-result-object v1

    .line 17
    invoke-virtual {v1, p3}, Landroidx/core/app/NotificationCompat$Builder;->p(I)Landroidx/core/app/NotificationCompat$Builder;
    ...
    .line 22
    :cond_3
    invoke-virtual {v0, p4}, Landroidx/core/app/NotificationCompat$Builder;->h(Landroid/app/PendingIntent;)Landroidx/core/app/NotificationCompat$Builder;
    ...
    .line 23
    invoke-virtual {v0, v6}, Landroidx/core/app/NotificationCompat$Builder;->q(I)Landroidx/core/app/NotificationCompat$Builder;
    ...
    invoke-virtual {v6, v4}, Landroidx/core/app/NotificationCompat$Builder;->s(Ljava/lang/CharSequence;)Landroidx/core/app/NotificationCompat$Builder;
    ...
    invoke-virtual {v4, v6, v7}, Landroidx/core/app/NotificationCompat$Builder;->t(J)Landroidx/core/app/NotificationCompat$Builder;

    move-result-object v4

    .line 26
    invoke-virtual {v4, p4}, Landroidx/core/app/NotificationCompat$Builder;->h(Landroid/app/PendingIntent;)Landroidx/core/app/NotificationCompat$Builder;

    move-result-object p4

    .line 27
    invoke-virtual {p4, v1}, Landroidx/core/app/NotificationCompat$Builder;->i(Ljava/lang/CharSequence;)Landroidx/core/app/NotificationCompat$Builder;
    ...
    invoke-static {p4}, Lcom/google/android/gms/common/internal/Preconditions;->k(Z)V

    .line 30
    invoke-direct {p0}, Lcom/google/android/gms/common/GoogleApiAvailability;->x()Ljava/lang/String;
    ...
    :cond_6
    :goto_1
    invoke-virtual {v0, p4}, Landroidx/core/app/NotificationCompat$Builder;->g(Ljava/lang/String;)Landroidx/core/app/NotificationCompat$Builder;
    ...
    .line 39
    sget-object p3, Lcom/google/android/gms/common/GooglePlayServicesUtilLight;->b:Ljava/util/concurrent/atomic/AtomicBoolean;
...
.method static final synthetic D(Ljava/util/Map;)Lcom/google/android/gms/tasks/Task;
    .locals 0
...
.method public static t(Landroid/app/Activity;Landroid/content/DialogInterface$OnCancelListener;)Landroid/app/Dialog;
    ...
    .line 6
    invoke-static {p0, v0}, Lcom/google/android/gms/common/internal/zac;->g(Landroid/content/Context;I)Ljava/lang/String;
...
.method static u(Landroid/content/Context;ILcom/google/android/gms/common/internal/zab;Landroid/content/DialogInterface$OnCancelListener;)Landroid/app/Dialog;
    .locals 5
    ...
    .line 9
    :cond_3
    invoke-static {p0, p1}, Lcom/google/android/gms/common/internal/zac;->i(Landroid/content/Context;I)Ljava/lang/String;
...
.method static final synthetic w(Ljava/util/Map;)Lcom/google/android/gms/tasks/Task;
    .locals 0
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/lang/Exception;
...
.method static y(Landroid/app/Activity;Landroid/app/Dialog;Ljava/lang/String;Landroid/content/DialogInterface$OnCancelListener;)V
    ...
    .line 4
    invoke-static {p1, p3}, Lcom/google/android/gms/common/SupportErrorDialogFragment;->p(Landroid/app/Dialog;Landroid/content/DialogInterface$OnCancelListener;)Lcom/google/android/gms/common/SupportErrorDialogFragment;
...
.method public final B(Landroid/app/Activity;Lcom/google/android/gms/common/api/internal/LifecycleFragment;IILandroid/content/DialogInterface$OnCancelListener;)Z
    ...
    .line 2
    invoke-static {p2, p4, v0}, Lcom/google/android/gms/common/internal/zab;->b(Lcom/google/android/gms/common/api/internal/LifecycleFragment;Landroid/content/Intent;I)Lcom/google/android/gms/common/internal/zab;

    move-result-object p2

    .line 3
    invoke-static {p1, p3, p2, p5}, Lcom/google/android/gms/common/GoogleApiAvailability;->u(Landroid/content/Context;ILcom/google/android/gms/common/internal/zab;Landroid/content/DialogInterface$OnCancelListener;)Landroid/app/Dialog;
...
.method public c(Landroid/content/Context;ILjava/lang/String;)Landroid/content/Intent;
    ...
    invoke-super {p0, p1, p2, p3}, Lcom/google/android/gms/common/GoogleApiAvailabilityLight;->c(Landroid/content/Context;ILjava/lang/String;)Landroid/content/Intent;
...
.method public d(Landroid/content/Context;II)Landroid/app/PendingIntent;
    ...
    invoke-super {p0, p1, p2, p3}, Lcom/google/android/gms/common/GoogleApiAvailabilityLight;->d(Landroid/content/Context;II)Landroid/app/PendingIntent;
...
.method public final f(I)Ljava/lang/String;
    ...
    invoke-super {p0, p1}, Lcom/google/android/gms/common/GoogleApiAvailabilityLight;->f(I)Ljava/lang/String;
...
.method public h(Landroid/content/Context;)I
    ...
    invoke-super {p0, p1}, Lcom/google/android/gms/common/GoogleApiAvailabilityLight;->h(Landroid/content/Context;)I
...
.method public i(Landroid/content/Context;I)I
    ...
    invoke-super {p0, p1, p2}, Lcom/google/android/gms/common/GoogleApiAvailabilityLight;->i(Landroid/content/Context;I)I
...
.method public final l(I)Z
    ...
    invoke-super {p0, p1}, Lcom/google/android/gms/common/GoogleApiAvailabilityLight;->l(I)Z
...
.method public o(Landroid/app/Activity;IILandroid/content/DialogInterface$OnCancelListener;)Landroid/app/Dialog;
    ...
    .line 2
    invoke-static {p1, v0, p3}, Lcom/google/android/gms/common/internal/zab;->a(Landroid/app/Activity;Landroid/content/Intent;I)Lcom/google/android/gms/common/internal/zab;

    move-result-object p3

    .line 3
    invoke-static {p1, p2, p3, p4}, Lcom/google/android/gms/common/GoogleApiAvailability;->u(Landroid/content/Context;ILcom/google/android/gms/common/internal/zab;Landroid/content/DialogInterface$OnCancelListener;)Landroid/app/Dialog;
...
.method public p(Landroid/content/Context;Lcom/google/android/gms/common/ConnectionResult;)Landroid/app/PendingIntent;
    ...
    .line 1
    invoke-virtual {p2}, Lcom/google/android/gms/common/ConnectionResult;->m0()Z
...
.method public s(Landroid/content/Context;I)V
    ...
    .line 1
    invoke-virtual {p0, p1, p2, v0, v1}, Lcom/google/android/gms/common/GoogleApiAvailabilityLight;->e(Landroid/content/Context;IILjava/lang/String;)Landroid/app/PendingIntent;
...
.method public final v(Landroid/content/Context;Lcom/google/android/gms/common/api/internal/zabl;)Lcom/google/android/gms/common/api/internal/zabj;
    .locals 2
    .annotation build Landroidx/annotation/Nullable;
    .end annotation
    ...
    invoke-direct {v1, p2}, Lcom/google/android/gms/common/api/internal/zabj;-><init>(Lcom/google/android/gms/common/api/internal/zabl;)V

    .line 4
    invoke-virtual {p1, v1, v0}, Landroid/content/Context;->registerReceiver(Landroid/content/BroadcastReceiver;Landroid/content/IntentFilter;)Landroid/content/Intent;

    .line 5
    invoke-virtual {v1, p1}, Lcom/google/android/gms/common/api/internal/zabj;->b(Landroid/content/Context;)V

    const-string v0, "com.google.android.gms"

    .line 6
    invoke-virtual {p0, p1, v0}, Lcom/google/android/gms/common/GoogleApiAvailabilityLight;->k(Landroid/content/Context;Ljava/lang/String;)Z
    ...
    .line 7
    invoke-virtual {p2}, Lcom/google/android/gms/common/api/internal/zabl;->a()V

    .line 8
    invoke-virtual {v1}, Lcom/google/android/gms/common/api/internal/zabj;->a()V
