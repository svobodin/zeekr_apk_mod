...
.method public final a(Ljava/util/concurrent/ExecutorService;)V
    ...
    invoke-virtual {p1, p0}, Lokhttp3/Dispatcher;->f(Lokhttp3/internal/connection/RealCall$AsyncCall;)V
    ...
    invoke-virtual {v0, p0}, Lokhttp3/Dispatcher;->f(Lokhttp3/internal/connection/RealCall$AsyncCall;)V
...
.method public run()V
    ...
    invoke-static {v3}, Lokhttp3/internal/connection/RealCall;->b(Lokhttp3/internal/connection/RealCall;)Lokhttp3/internal/connection/RealCall$timeout$1;

    move-result-object v3

    invoke-virtual {v3}, Lokio/AsyncTimeout;->s()V
    :try_end_0
    ...
    invoke-virtual {v3}, Lokhttp3/internal/connection/RealCall;->q()Lokhttp3/Response;
    ...
    invoke-interface {v4, v5, v0}, Lokhttp3/Callback;->a(Lokhttp3/Call;Lokhttp3/Response;)V
    :try_end_2
    ...
    invoke-interface {v4, v5, v3}, Lokhttp3/Callback;->b(Lokhttp3/Call;Ljava/io/IOException;)V
    ...
    invoke-static {v5}, Lokhttp3/internal/connection/RealCall;->c(Lokhttp3/internal/connection/RealCall;)Ljava/lang/String;
    ...
    invoke-virtual {v3, v4, v5, v0}, Lokhttp3/internal/platform/Platform;->k(Ljava/lang/String;ILjava/lang/Throwable;)V
    ...
    invoke-interface {v3, v4, v0}, Lokhttp3/Callback;->b(Lokhttp3/Call;Ljava/io/IOException;)V
    :try_end_4
    ...
    invoke-virtual {v3}, Lokhttp3/internal/connection/RealCall;->k()Lokhttp3/OkHttpClient;

    move-result-object v3

    invoke-virtual {v3}, Lokhttp3/OkHttpClient;->p()Lokhttp3/Dispatcher;

    move-result-object v3

    invoke-virtual {v3, p0}, Lokhttp3/Dispatcher;->f(Lokhttp3/internal/connection/RealCall$AsyncCall;)V
