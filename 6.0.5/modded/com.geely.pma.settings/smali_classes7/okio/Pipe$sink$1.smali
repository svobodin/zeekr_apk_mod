...
.method public close()V
    ...
    .line 12
    sget-object v5, Lokio/Timeout;->e:Lokio/Timeout$Companion;
    ...
    invoke-virtual {v2, v5, v6, v7}, Lokio/Timeout;->g(JLjava/util/concurrent/TimeUnit;)Lokio/Timeout;
    ...
    invoke-virtual {v2, v8, v9}, Lokio/Timeout;->d(J)Lokio/Timeout;
    ...
    .line 18
    invoke-virtual {v2, v3, v4, v7}, Lokio/Timeout;->g(JLjava/util/concurrent/TimeUnit;)Lokio/Timeout;
    ...
    .line 20
    invoke-virtual {v2, v5, v6}, Lokio/Timeout;->d(J)Lokio/Timeout;
    ...
    .line 29
    invoke-virtual {v2}, Lokio/Timeout;->a()Lokio/Timeout;
    ...
    invoke-virtual {v2, v3, v4, v5}, Lokio/Timeout;->g(JLjava/util/concurrent/TimeUnit;)Lokio/Timeout;
...
.method public k0(Lokio/Buffer;J)V
    ...
    invoke-virtual {v5}, Lokio/Buffer;->b1()J
    ...
    invoke-virtual {v3, p1, v1, v2}, Lokio/Buffer;->k0(Lokio/Buffer;J)V
    ...
    .line 18
    sget-object v2, Lokio/Timeout;->e:Lokio/Timeout$Companion;
    ...
    invoke-virtual {v1, v6, v7, v2}, Lokio/Timeout;->g(JLjava/util/concurrent/TimeUnit;)Lokio/Timeout;

    .line 19
    invoke-virtual {v1}, Lokio/Timeout;->e()Z
    ...
    .line 20
    invoke-virtual {v1}, Lokio/Timeout;->c()J
    ...
    invoke-virtual {v1, v8, v9}, Lokio/Timeout;->d(J)Lokio/Timeout;

    .line 23
    :cond_6
    :try_start_1
    invoke-interface {v3, p1, p2, p3}, Lokio/Sink;->k0(Lokio/Buffer;J)V
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0

    .line 24
    invoke-virtual {v1, v4, v5, v2}, Lokio/Timeout;->g(JLjava/util/concurrent/TimeUnit;)Lokio/Timeout;
    ...
    .line 26
    invoke-virtual {v1, v6, v7}, Lokio/Timeout;->d(J)Lokio/Timeout;
    ...
    invoke-virtual {v1, v4, v5, p2}, Lokio/Timeout;->g(JLjava/util/concurrent/TimeUnit;)Lokio/Timeout;
