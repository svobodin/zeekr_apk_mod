.class public final Lcom/zeekr/sdk/vehicle/impl/CarAudioManagerProxy;
.super Ljava/lang/Object;
.source "CarAudioManagerProxy.java"

# interfaces
.implements Lcom/zeekr/sdk/vehicle/ability/ICarAudioManager;


# annotations
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/zeekr/sdk/vehicle/impl/CarAudioManagerProxy$CarVolumeChangeCallbackWrapper;
    }
.end annotation
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcom/zeekr/sdk/vehicle/impl/CarAudioManagerProxy;->a:Ljava/util/concurrent/ConcurrentHashMap;
...
# virtual methods
.method public final getUsageMaxVolume(Ljava/lang/String;)I
    .locals 6
    ...
    const-string v3, "getUsageMaxVolume"
    ...
    const-string v1, "CarAudioManagerProxy"
...
.method public final getUsageMinVolume(Ljava/lang/String;)I
    .locals 6
    ...
    const-string v3, "getUsageMinVolume"
...
.method public final getUsageVolume(Ljava/lang/String;)I
    .locals 6
    ...
    const-string v3, "getUsageVolume"
...
.method public final registerCarVolumeChangeCallback(Lcom/zeekr/sdk/vehicle/ability/ICarAudioManager$a;)Z
    .locals 11
    ...
    .line 1
    :cond_0
    iget-object v1, p0, Lcom/zeekr/sdk/vehicle/impl/CarAudioManagerProxy;->a:Ljava/util/concurrent/ConcurrentHashMap;

    invoke-virtual {v1, p1}, Ljava/util/concurrent/ConcurrentHashMap;->get(Ljava/lang/Object;)Ljava/lang/Object;

    move-result-object v1

    check-cast v1, Lcom/zeekr/sdk/vehicle/impl/CarAudioManagerProxy$CarVolumeChangeCallbackWrapper;

    const-string v2, "Has register CarVolumeChangeCallbackWrapper"

    const-string v3, "CarAudioManagerProxy"

    if-nez v1, :cond_2

    .line 3
    new-instance v1, Lcom/zeekr/sdk/vehicle/impl/CarAudioManagerProxy$CarVolumeChangeCallbackWrapper;

    invoke-direct {v1, p0, p1}, Lcom/zeekr/sdk/vehicle/impl/CarAudioManagerProxy$CarVolumeChangeCallbackWrapper;-><init>(Lcom/zeekr/sdk/vehicle/impl/CarAudioManagerProxy;Lcom/zeekr/sdk/vehicle/ability/ICarAudioManager$a;)V
    ...
    const-string v7, "registerCarVolumeChangeCallback"
    ...
    invoke-virtual {v1}, Lcom/zeekr/sdk/openapi/vehicle/car/audio/ICarVolumeChangeCallback$Stub;->asBinder()Landroid/os/IBinder;
    ...
    .line 12
    iget-object p0, p0, Lcom/zeekr/sdk/vehicle/impl/CarAudioManagerProxy;->a:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    :cond_1
    const-string p0, "Can\'t register CarVolumeChangeCallbackWrapper"
...
.method public final unRegisterCarVolumeChangeCallback(Lcom/zeekr/sdk/vehicle/ability/ICarAudioManager$a;)Z
    .locals 10
    ...
    const-string v2, "CarAudioManagerProxy"
    ...
    const-string v6, "unRegisterCarVolumeChangeCallback"
    ...
    const-string p0, "has unregister CarVolumeChangeCallbackWrapper"
    ...
    :cond_1
    const-string p0, "cannot unregister CarVolumeChangeCallbackWrapper"
